...
public class Thief : Attack
{
    public Thief()
    {
        ...
        Name = Localization.GetString($"move_name_{ID}", "Thief");
    ...
    public override void MoveHits(bool own, BattleScreen battleScreen)
    {
        ...
        if (p.Item == null)
        {
            ...
            if (battleScreen.Battle.RemoveHeldItem(own == false, own, battleScreen, "Thief stole the item " + op.Item.OneLineName() + " from " + op.GetDisplayName() + "!", "move:thief", true))
            {
