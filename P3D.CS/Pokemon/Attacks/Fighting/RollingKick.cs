...
public class RollingKick : Attack
{
    public RollingKick()
    {
        // #Definitions
        ...
        Name = Localization.GetString($"move_name_{ID}", "Rolling Kick");
    ...
    public override void MoveHits(bool own, BattleScreen battleScreen)
    {
        ...
        if (substitute == 0)
        {
            ...
            {
                battleScreen.Battle.InflictFlinch(own == false, own, battleScreen, "", "move:rollingkick");
            }
        }
    }
