...
public class Ember : Attack
{
    ...
    public override void InternalUserPokemonMoveAnimation(BattleScreen battleScreen, bool battleFlip, Pokemon currentPokemon, NPC currentEntity)
    {
        ...
        Object FireballEntity = MoveAnimation.SpawnEntity(new Vector3(0), TextureManager.GetTexture(@"Textures\Battle\Fire\FireBall", new Rectangle(0, TextureYOffset, 32, 32), ""), new Vector3(0.5F), 1.0F);
    ...
    public override void InternalOpponentPokemonMoveAnimation(BattleScreen battleScreen, bool battleFlip, Pokemon currentPokemon, NPC currentEntity)
    {
        ...
        Object FireballEntity = MoveAnimation.SpawnEntity(new Vector3(-2.0f, 0.0f, 0.0f), TextureManager.GetTexture(@"Textures\Battle\Fire\FireBall", new Rectangle(0, TextureYOffset, 32, 32), ""), new Vector3(0.5F), 1.0F);
