...
public class NeedleArm : Attack
{
    public NeedleArm()
    {
        ...
        Name = Localization.GetString($"move_name_{ID}", "Needle Arm");
    ...
    public override void MoveHits(bool own, BattleScreen battleScreen)
    {
        ...
        if (substitute == 0)
        {
            ...
            {
                battleScreen.Battle.InflictFlinch(own == false, own, battleScreen, "", "move:needlearm");
            }
        }
    }
