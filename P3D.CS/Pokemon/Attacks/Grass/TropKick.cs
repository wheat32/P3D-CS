...
public class TropKick : Attack
{
    public TropKick()
    {
        ...
        Name = Localization.GetString($"move_name_{ID}", "Trop Kick");
    ...
    {
        battleScreen.Battle.LowerStat(own == false, own, battleScreen, "Attack", 1, "", "move:tropkick");
    }
