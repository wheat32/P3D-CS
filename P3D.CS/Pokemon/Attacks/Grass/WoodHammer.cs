...
public class WoodHammer : Attack
{
    public WoodHammer()
    {
        // #Definitions
        ...
        Name = Localization.GetString($"move_name_{ID}", "Wood Hammer");
    ...
    public override void MoveRecoil(bool own, BattleScreen battleScreen)
    {
        ...
        battleScreen.Battle.InflictRecoil(own, own, battleScreen, this, recoilDamage, "", "move:woodhammer");
    }
