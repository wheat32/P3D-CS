...
public class IceFang : Attack
{
    public IceFang()
    {
        ...
        Name = Localization.GetString($"move_name_{ID}", "Ice Fang");
    ...
    public override void MoveHits(bool own, BattleScreen battleScreen)
    {
        if (battleScreen.FieldEffects.MovesFirst(own) == true)
        {
            ...
            {
                battleScreen.Battle.InflictFlinch(own == false, own, battleScreen, "", "move:icefang");
            }
            else
            {
                ...
                {
                    battleScreen.Battle.InflictFreeze(own == false, own, battleScreen, "", "move:icefang");
                }
            }
        }
        else
