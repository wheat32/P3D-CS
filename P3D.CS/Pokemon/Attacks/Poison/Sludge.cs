...
public class Sludge : Attack
{
    public Sludge()
    {
        ...
        Name = Localization.GetString($"move_name_{ID}", "Sludge");
    ...
    public override void MoveHits(bool own, BattleScreen battleScreen)
    {
        ...
        {
            battleScreen.Battle.InflictPoison(own == false, own, battleScreen, false, "", "move:sludge");
        }
    }
