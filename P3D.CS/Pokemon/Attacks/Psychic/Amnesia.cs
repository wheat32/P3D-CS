...
public class Amnesia : Attack
{
    public Amnesia()
    {
        ...
        Name = Localization.GetString($"move_name_{ID}", "Amnesia");
    ...
    {
        if (battleScreen.Battle.RaiseStat(own, own, battleScreen, "Special Defense", 2, "", "move:amnesia") == false)
        {
