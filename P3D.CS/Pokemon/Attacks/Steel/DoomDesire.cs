...
public class DoomDesire : Attack
{
    public DoomDesire()
    {
        // #Definitions
        ...
        Name = Localization.GetString($"move_name_{ID}", "Doom Desire");
    ...
    public override void MoveHits(bool own, BattleScreen battleScreen)
    {
        ...
        if (own == true)
        {
            ...
            {
                battleScreen.FieldEffects.FutureSightTurns.Self = 2;
                battleScreen.FieldEffects.FutureSightID.Self = 1;
        ...
        else
        {
            ...
            {
                battleScreen.FieldEffects.FutureSightTurns.Opponent = 2;
                battleScreen.FieldEffects.FutureSightID.Opponent = 1;
