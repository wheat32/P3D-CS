...
public class KingsShield : Attack
{
    public KingsShield()
    {
        // #Definitions
        ...
        Name = Localization.GetString($"move_name_{ID}", "King's Shield");
        Description = "The user takes a defensive stance while it protects itself from damage. It also lowers the Attack stat of any attacker who makes direct contact.";
        criticalChance = 0;
        isHMMove = false;
        target = Targets.Self;
        priority = 3;
    ...
    public override void MoveHits(bool own, BattleScreen battleScreen)
    {
        if (own == true)
        {
            ...
            battleScreen.FieldEffects.KingsShieldCounter.Self = 1;
        }
        else
        {
            battleScreen.FieldEffects.ProtectMovesCount.Opponent += 1;

            battleScreen.FieldEffects.KingsShieldCounter.Opponent = 1;
        }
