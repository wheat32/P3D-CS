...
[Item(46, "Fresh Water")]
public class FreshWater : MedicineItem
{
    public override int PokeDollarPrice { get; protected set; } = 200;
    public override String Description { get; protected set; } = "Water with a high mineral content. When consumed, it restores 30 HP to an injured Pokémon.";
