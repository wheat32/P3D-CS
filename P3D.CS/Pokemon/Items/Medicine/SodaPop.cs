...
[Item(47, "Soda Pop")]
public class SodaPop : MedicineItem
{
    public override bool IsHealingItem { get; } = true;
    public override String Description { get; protected set; } = "A highly carbonated soda drink. When consumed, it restores 50 HP to an injured Pokémon.";
